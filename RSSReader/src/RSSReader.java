...
public final class RSSReader {
    ...
    public static void main(String[] args) {
        ...
        //boolean to keep track if rss is valid
        boolean validRSS = false;

        out1.println("Enter the URL to a valid RSS 2.0 Feed");
        ...
        if (validRSS) {
            out1.println("RSS feed generated successfully! Check HTML file");

        } else {
            out1.println("Invalid RSS link. Program will terminate");
        }
